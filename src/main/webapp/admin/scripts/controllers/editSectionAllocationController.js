...
angular.module('persistencelayer').controller('EditSectionAllocationController', function($scope, $routeParams, $location, SectionAllocationResource , PerformanceResource, SectionResource) {
    var self = this;
