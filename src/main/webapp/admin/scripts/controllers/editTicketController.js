...
angular.module('persistencelayer').controller('EditTicketController', function($scope, $routeParams, $location, TicketResource , TicketCategoryResource, SectionResource) {
    var self = this;
