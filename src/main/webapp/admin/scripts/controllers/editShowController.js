...
angular.module('persistencelayer').controller('EditShowController', function($scope, $routeParams, $location, ShowResource , EventResource, VenueResource, PerformanceResource, TicketPriceResource) {
    var self = this;
