...
angular.module('persistencelayer').controller('NewSectionAllocationController', function ($scope, $location, locationParser, SectionAllocationResource , PerformanceResource, SectionResource) {
