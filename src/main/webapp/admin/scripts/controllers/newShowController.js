...
angular.module('persistencelayer').controller('NewShowController', function ($scope, $location, locationParser, ShowResource , EventResource, VenueResource, PerformanceResource, TicketPriceResource) {
