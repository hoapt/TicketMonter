...
angular.module('persistencelayer').controller('EditEventController', function($scope, $routeParams, $location, EventResource , MediaItemResource, EventCategoryResource) {
    var self = this;
