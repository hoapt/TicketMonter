...
angular.module('persistencelayer').controller('NewEventController', function ($scope, $location, locationParser, EventResource , MediaItemResource, EventCategoryResource) {
