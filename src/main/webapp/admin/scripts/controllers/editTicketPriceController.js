...
angular.module('persistencelayer').controller('EditTicketPriceController', function($scope, $routeParams, $location, TicketPriceResource , ShowResource, SectionResource, TicketCategoryResource) {
    var self = this;
