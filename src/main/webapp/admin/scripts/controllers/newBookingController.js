...
angular.module('persistencelayer').controller('NewBookingController', function ($scope, $location, locationParser, BookingResource , TicketResource, PerformanceResource) {
