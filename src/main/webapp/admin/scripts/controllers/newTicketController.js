...
angular.module('persistencelayer').controller('NewTicketController', function ($scope, $location, locationParser, TicketResource , TicketCategoryResource, SectionResource) {
