...
angular.module('persistencelayer').controller('NewTicketPriceController', function ($scope, $location, locationParser, TicketPriceResource , ShowResource, SectionResource, TicketCategoryResource) {
