...
angular.module('persistencelayer').controller('EditBookingController', function($scope, $routeParams, $location, BookingResource , TicketResource, PerformanceResource) {
    var self = this;
